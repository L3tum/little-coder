...
export interface McpSettings {
  ...
  /**
   * Auto-connect to all configured MCP servers at startup.
   * When true, all servers are connected during initialization (same as eager).
   * When false (default), only keep-alive and eager servers connect at startup.
   */
  autoConnect?: boolean;
}

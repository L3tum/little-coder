...
const INTENT_MAP: Record<string, string[]> = {
  ...
  find: ["glob", "grep", "findRead", "code_search"], search: ["grep", "findRead", "code_search"],
  grep: ["grep"], glob: ["glob", "findRead"],
  // Code graph / structural code search
  function: ["code_search", "grep"], class: ["code_search", "grep"],
  where: ["code_search"], calls: ["code_search"],
  callsite: ["code_search"], caller: ["code_search"],
  implementation: ["code_search"], implements: ["code_search"],
  reference: ["code_search"], references: ["code_search"],
  dependency: ["code_search"], depends: ["code_search"],
  route: ["code_search"], endpoint: ["code_search"],
  symbol: ["code_search"], definition: ["code_search"],
  declare: ["code_search"], declares: ["code_search"],
  variable: ["code_search"], module: ["code_search"],
  import: ["code_search"], exports: ["code_search"],
  struct: ["code_search"], interface: ["code_search"],
  inherit: ["code_search"], extends: ["code_search"],
  override: ["code_search"], overrides: ["code_search"],
  codegraph: ["code_search"], codebase: ["code_search"],
  graph: ["code_search"], semantic: ["code_search"],
  "what calls": ["code_search"], "where is": ["code_search"],
  "who uses": ["code_search"], "find all": ["code_search"],
  "search code": ["code_search"], "code search": ["code_search"],
  "find usage": ["code_search"], "find usages": ["code_search"],
  "find implement": ["code_search"], "find definition": ["code_search"],
  "go to definition": ["code_search"], "find references": ["code_search"],
  "call graph": ["code_search"], "call hierarchy": ["code_search"],
  "type hierarchy": ["code_search"], "class hierarchy": ["code_search"],
  "rename across": ["code_search"], "safe delete": ["code_search"],
  "impact analysis": ["code_search"], "affected by": ["code_search"],
